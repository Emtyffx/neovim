...

{
  ...
  inputs = {
    ...
    nixCats.url = "github:Emtyffx/nixCats-nvim";
    ...
    let
      ...
      dependencyOverlays = # (import ./overlays inputs) ++
        [
          ...
          # `plugins-<pluginName>`
          # Once we add this overlay to our nixpkgs, we are able to use `pkgs.neovimPlugins`, which is a set of our plugins.
          (utils.standardPluginOverlay inputs) # add any other flake overlays here.
